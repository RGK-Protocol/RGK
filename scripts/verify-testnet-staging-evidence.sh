...
require_regex "public covenant confirmation wait" 'live: waiting for public testnet confirmation of covenant tx'
...
require_regex "public covenant spend confirmation wait" 'live: waiting for public testnet confirmation of covenant spend'
